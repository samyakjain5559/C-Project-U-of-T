...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_1: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_1 ${OBJECTFILES} ${LDLIBSOPTIONS} -lX11

${OBJECTDIR}/_ext/43898991/easygl.o: ../../easygl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/easygl.o ../../easygl.cpp

${OBJECTDIR}/_ext/43898991/graphics.o: ../../graphics.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/graphics.o ../../graphics.cpp
...
${OBJECTDIR}/_ext/1472/Node.o: ../Node.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Node.o ../Node.cpp

${OBJECTDIR}/_ext/1472/NodeList.o: ../NodeList.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/NodeList.o ../NodeList.cpp

${OBJECTDIR}/_ext/1472/Resistor.o: ../Resistor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Resistor.o ../Resistor.cpp

${OBJECTDIR}/_ext/1472/ResistorList.o: ../ResistorList.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/ResistorList.o ../ResistorList.cpp

${OBJECTDIR}/_ext/1472/Rparser.o: ../Rparser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/Rparser.o ../Rparser.cpp
